	...
	public String execute(RequestInfo request) {
	    ...
	    */
	    ...
	    while(recordSet.next()){
			...
			String VoucherAbstract=sqr+"申请支付"+skr+recordSet.getString("zy"); //摘要
			...
			String EASkh=recordSet.getString("EASkh1"); //EAS客户
			String EASgys=recordSet.getString("EASgys1"); //EAS供应商
		    String EASzy=recordSet.getString("j_zy1");//借方职员
		    String jfyh=recordSet.getString("j_yx1");//借方银行
