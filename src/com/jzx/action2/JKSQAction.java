	    ...
	    */
	    ...
	    while(recordSet.next()){
			...
			if(abstractType.equals("办公室")){
				VoucherAbstract=fygsbm+skr+"借支"+recordSet.getString("jdzysm"); //摘要
			}else if(abstractType.equals("店铺")){
				VoucherAbstract=sqr+skr+"借支"+recordSet.getString("jdzysm"); //摘要
			}
			...
			String EASzzdw=recordSet.getString("j_cbzx1"); //EAS组织单元
