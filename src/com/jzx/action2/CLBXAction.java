	...
	public String execute(RequestInfo request) {
	    ...
	    while(recordSet.next()){
			...
			if(abstractType.equals("办公室")){
				VoucherAbstract=fygsbm+skr+"报销"+recordSet.getString("jdzysm")+"差旅费"; //摘要
			}else if(abstractType.equals("店铺")){
				VoucherAbstract=sqr+skr+"报销"+recordSet.getString("jdzysm")+"差旅费"; //摘要
			}
			...
			String EASzzdw=recordSet.getString("EAScbzx1"); //EAS组织单元
			String EASzy=recordSet.getString("EASzy1"); //EAS职员
			...
			if(se>0){
				...
				String slkjkm=easUtil.getSlkjkm("10666", recordSet.getString("sl")); //税率会计客户
