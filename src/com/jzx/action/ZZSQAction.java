 ...
 *
 */
public class ZZSQAction extends BaseBean implements Action{
	...
	public String execute(RequestInfo request) {
	    ...
	    if(recordSet.next()){
	    	...
	    	fygsbm=departmentComInfo.getDepartmentname(recordSet.getString("bm"));
	    	...
	    	dforiginalAmount=recordSet.getDouble("zzje");
	    	dfcreditAmount=dforiginalAmount;
	    	
	    	zckm=easUtil.getSelectName("10888", recordSet.getString("dfkm"));
	    ...
	    while(recordSet.next()){
			...
			String VoucherAbstract="支付"+fygsbm+sqr+"转账"+recordSet.getString("jdzysm"); //摘要
			if(index==1){
				dfVoucherAbstract=VoucherAbstract;
			}
