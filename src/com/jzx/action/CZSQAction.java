...
public class CZSQAction extends BaseBean implements Action{
	...
	public String execute(RequestInfo request) {
	    ...
	    if(recordSet.next()){
	    	...
	    	fzzlx=recordSet.getString("fzzlx"); //辅助账类型
			EASzzdw=recordSet.getString("EASzzdw"); //EAS组织单元
			EASkh=recordSet.getString("EASkh"); //EAS客户
			EASgys=recordSet.getString("EASgys"); //EAS供应商
			EASzy=recordSet.getString("EASzy"); //EAS职员
	    ...
	    while(recordSet.next()){
			...
			String dfzzlx=recordSet.getString("fzzlx"); //辅助账类型
			String dEASzzdw=recordSet.getString("EASzzdw"); //EAS组织单元
			String dEASkh=recordSet.getString("EASkh"); //EAS客户
			String dEASgys=recordSet.getString("EASgys"); //EAS供应商
			String dEASzy=recordSet.getString("EASzy"); //EAS职员
