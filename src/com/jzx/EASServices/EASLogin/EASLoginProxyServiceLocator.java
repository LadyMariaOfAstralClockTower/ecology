...
public class EASLoginProxyServiceLocator extends org.apache.axis.client.Service implements com.jzx.EASServices.EASLogin.EASLoginProxyService {
    ...
    private java.lang.String EASLogin_address = "http://172.172.0.20:6888/ormrpc/services/EASLogin";
    ...
    public com.jzx.EASServices.EASLogin.EASLoginProxy getEASLogin(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.jzx.EASServices.EASLogin.EASLoginSoapBindingStub _stub = new com.jzx.EASServices.EASLogin.EASLoginSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.jzx.EASServices.EASLogin.EASLoginProxy.class.isAssignableFrom(serviceEndpointInterface)) {
                com.jzx.EASServices.EASLogin.EASLoginSoapBindingStub _stub = new com.jzx.EASServices.EASLogin.EASLoginSoapBindingStub(new java.net.URL(EASLogin_address), this);
                _stub.setPortName(getEASLoginWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://172.172.0.20:6888/ormrpc/services/EASLogin", "EASLoginProxyService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://172.172.0.20:6888/ormrpc/services/EASLogin", "EASLogin"));
        }
