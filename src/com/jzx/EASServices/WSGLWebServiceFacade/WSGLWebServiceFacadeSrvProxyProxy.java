...
public class WSGLWebServiceFacadeSrvProxyProxy implements com.jzx.EASServices.WSGLWebServiceFacade.WSGLWebServiceFacadeSrvProxy {
  private String _endpoint = null;
  private com.jzx.EASServices.WSGLWebServiceFacade.WSGLWebServiceFacadeSrvProxy wSGLWebServiceFacadeSrvProxy = null;
  ...
  private void _initWSGLWebServiceFacadeSrvProxyProxy() {
    try {
      wSGLWebServiceFacadeSrvProxy = (new com.jzx.EASServices.WSGLWebServiceFacade.WSGLWebServiceFacadeSrvProxyServiceLocator()).getWSGLWebServiceFacade();
  ...
  public com.jzx.EASServices.WSGLWebServiceFacade.WSGLWebServiceFacadeSrvProxy getWSGLWebServiceFacadeSrvProxy() {
    if (wSGLWebServiceFacadeSrvProxy == null)
      _initWSGLWebServiceFacadeSrvProxyProxy();
